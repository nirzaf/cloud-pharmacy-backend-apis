...
using CloudPharmacy.PharmacyStore.API.Core.DependecyInjection;
...
{
    options.AddPolicy("Customer", configurePolicy =>
    {
        configurePolicy.RequireClaim(ClaimConstants.Scope, "medicaments.purchase");
    });
});
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Version = "v1",
        Title = "Cloud Pharmacy Store API",
        Description = "API to manage Cloud Pharmacy Medicament's data",
